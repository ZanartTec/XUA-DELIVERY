    ...
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="space-y-1.5">
          <label htmlFor="email" className="text-[11px] font-semibold tracking-widest text-muted-foreground uppercase">
            Endereço de Email
          </label>
          <Input
            id="email"
            ...
            className="h-12 rounded-xl border-0 bg-white/70 backdrop-blur-sm text-foreground placeholder:text-muted-foreground/70 shadow-none focus:bg-white focus:ring-2 focus:ring-ring/20"
            {...register("email")}
          />
          {errors.email && (
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-between">
            <label htmlFor="password" className="text-[11px] font-semibold tracking-widest text-muted-foreground uppercase">
              Senha
            </label>
            <button type="button" className="text-xs text-primary hover:text-primary-hover font-medium">
              Esqueceu?
            </button>
          </div>
          <Input
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          type="button"
          className="flex h-12 items-center justify-center gap-2 rounded-xl border border-border/40 bg-white/60 backdrop-blur-sm text-sm font-semibold text-foreground transition-colors hover:bg-white/80"
        >
