...
export default function ReconciliationPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <Button className="w-full rounded-xl bg-[#00E0FF] hover:bg-[#00E0FF]/90 text-[#001735] font-semibold shadow-none active:scale-[0.98]" disabled={!canSubmit} onClick={handleSubmit}>
