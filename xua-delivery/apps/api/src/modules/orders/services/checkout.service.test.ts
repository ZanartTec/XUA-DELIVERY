...
vi.mock("../../consumers/repository/consumers.repository.js", () => ({
  consumerRepository: mocks.consumerRepository,
}));
vi.mock("../../zones/repository/zones.repository.js", () => ({
  zonesRepository: mocks.zonesRepository,
}));
vi.mock("../../products/repository/products.repository.js", () => ({
  productsRepository: mocks.productsRepository,
}));
vi.mock("../../distributor/services/distributor.service.js", () => ({
  distributorService: mocks.distributorService,
}));
vi.mock("./create-order.service.js", () => ({
