...
const EXPECTED_ENUMS = {
  ...
  ProductKind: { values: PRODUCT_KIND_VALUES, object: ProductKind },
  ...
  DepositMovementType: { values: DEPOSIT_MOVEMENT_TYPE_VALUES, object: DepositMovementType },
