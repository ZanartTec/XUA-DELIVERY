...
vi.mock("@api/infra/auth/password.js", () => ({
...
const { distributorService, DistributorServiceError } = await import("@api/modules/distributor/services/distributor.service.js");
