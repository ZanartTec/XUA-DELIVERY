...
vi.mock("@api/infra/rate-limit/limiter.js", () => ({
  RATE_LIMITS: { authenticatedWrite: { windowSeconds: 60, maxRequests: 30 } },
}));

vi.mock("@api/modules/distributor/services/kpi.service.js", () => ({
...
vi.mock("@api/modules/distributor/repository/schedule.repository.js", () => ({
...
vi.mock("@api/modules/distributor/services/route.service.js", () => ({
...
vi.mock("@api/modules/inventory/services/reconciliation-session.service.js", () => ({
  InventoryReconciliationSessionError: mocks.InventoryReconciliationSessionError,
}));

const { distributorRoutes } = await import("@api/modules/distributor/index.js");
