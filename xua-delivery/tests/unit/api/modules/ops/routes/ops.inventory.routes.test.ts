...
vi.mock("@api/modules/ops/controllers/kpi.controller.js", () => ({
  kpiController: { get: vi.fn() },
}));

vi.mock("@api/modules/ops/controllers/audit.controller.js", () => ({
  auditController: { exportCsv: vi.fn() },
}));

vi.mock("@api/modules/ops/services/inventory-read.service.js", () => ({
...
const { opsRoutes } = await import("@api/modules/ops/index.js");
