...
vi.mock("@api/modules/ops/repository/inventory-read.repository.js", () => ({
  opsInventoryReadRepository: mocks.repository,
}));

const { opsInventoryReadService } = await import("@api/modules/ops/services/inventory-read.service.js");
