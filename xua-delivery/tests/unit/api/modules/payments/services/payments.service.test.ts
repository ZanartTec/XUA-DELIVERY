...
vi.mock("@api/modules/payments/gateway/payments.gateway.js", () => ({
...
vi.mock("@api/modules/audit/index.js", () => ({
...
const { paymentService } = await import("@api/modules/payments/services/payments.service.js");
