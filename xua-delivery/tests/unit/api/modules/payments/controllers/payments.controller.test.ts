...
import { signWebhookContext } from "@api/modules/payments/utils/webhook-context.js";
...
vi.mock("@api/infra/queue/index.js", () => ({
...
vi.mock("@api/modules/distributor-gateway/index.js", () => ({
...
const { paymentsController } = await import("@api/modules/payments/controllers/payments.controller.js");
