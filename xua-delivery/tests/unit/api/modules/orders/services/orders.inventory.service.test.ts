...
vi.mock("@api/infra/redis/client.js", () => ({
  default: { get: vi.fn() },
}));
...
vi.mock("@api/modules/inventory/repository/inventory.repository.js", () => ({
  inventoryRepository: mocks.inventoryRepository,
}));

vi.mock("@api/modules/inventory/services/inventory.service.js", () => ({
...
vi.mock("@api/modules/deposits/services/deposit-settlement.service.js", () => ({
...
vi.mock("@api/modules/notifications/services/notification.service.js", () => ({
  notificationService: mocks.notificationService,
}));

vi.mock("@api/modules/user-subscriptions/services/subscription-settlement.service.js", () => ({
...
vi.mock("@api/modules/payments/services/payments.service.js", () => ({
...
vi.mock("@api/infra/queue/payment-jobs.producer.js", () => ({
  enqueueRefundPaymentJob: mocks.enqueueRefundPaymentJob,
}));

const { orderService, OrderServiceError } = await import("@api/modules/orders/services/orders.service.js");
