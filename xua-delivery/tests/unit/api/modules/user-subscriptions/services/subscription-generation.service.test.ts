...
vi.mock("@api/infra/prisma/client.js", () => ({ getPrisma: () => mocks.prisma }));
vi.mock("@api/infra/logger/index.js", () => ({ createLogger: () => mocks.logger }));
vi.mock("@api/modules/orders/services/orders.service.js", () => ({ orderService: mocks.orderService }));
...
vi.mock("@api/modules/user-subscriptions/repository/user-subscriptions.repository.js", () => ({
  userSubscriptionsRepository: mocks.repo,
}));

const { subscriptionGenerationService } = await import("@api/modules/user-subscriptions/services/subscription-generation.service.js");
