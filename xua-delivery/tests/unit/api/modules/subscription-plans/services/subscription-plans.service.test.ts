...
vi.mock("@api/modules/subscription-plans/repository/subscription-plans.repository.js", () => ({
...
const { subscriptionPlansService } = await import("@api/modules/subscription-plans/services/subscription-plans.service.js");
