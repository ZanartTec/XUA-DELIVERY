...
vi.mock("@api/infra/redis/cache.js", () => ({
...
vi.mock("@api/modules/inventory/services/inventory-item-provisioning.service.js", () => ({
...
const { productsService } = await import("@api/modules/products/services/products.service.js");
